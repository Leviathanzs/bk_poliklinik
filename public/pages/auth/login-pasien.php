...
if (isset($_POST['submit'])) {
    ...
    if ($username == 'admin' && $password == 'admin') {
        ...
        $cek_username = $conn->prepare("SELECT * FROM pasien WHERE nama = :username");
        try {
...
<head>
    ...
    <style>
        ...
        .border-top-blue {
            border-top: 6px solid blue; /* Set the border top color and width */
        }
    </style>
</head>
<body>
    <div class="d-flex justify-content-center align-items-center form-container">
            <form method="POST" action="" class="bg-white p-4 rounded shadow-lg w-100 border-top-blue" style="max-width: 400px;">
                ...
                <div class="mt-2">
                    <p>Doesn' have an account? <a href="register.php" class="text-decoration-none">Register here!</a></p>
                </div>
                <?php if (!empty($_SESSION['error'])): ?>
                    <p class="text-danger text-sm mb-4"><?= $_SESSION['error'] ?></p>
